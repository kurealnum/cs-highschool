...
pyramid_slant_length = math.sqrt(
    ((1 / 2 * pyramid_base_length) ** 2) + pyramid_height**2
)

# calculating the total surface area, rounded to the 2nd decimal place
pyramid_surface_area = round(
    pyramid_base_area + (0.5 * (4 * pyramid_base_length * pyramid_slant_length)), 2
)
